...
VERSION=$(shell echo "from ipwhere import __VERSION__; print(__VERSION__)" | python)
...
# TODO: Use rm -Rfv $$(find $(PACKAGE) | awk '/__pycache__$$/') after the ipwhere
...
manpage:
	...
	pandoc --standalone --to man README.md -o $(MANPAGES)/ipwhere.1
